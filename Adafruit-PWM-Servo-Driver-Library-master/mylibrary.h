...
const int SERVOMAX = 400;       // this value depends on the adjustment of the servos
...
//Stretching and Control of Fingers
void stretch_flexion_indexfinger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void flexion_stretch_indexfinger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void stretch_flexion_thumb(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void flexion_stretch_thumb(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void stretch_flexion_middlefinger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void flexion_stretch_middlefinger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void stretch_flexion_ring_little_finger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void flexion_stretch_ring_little_finger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void stretch_flexion_all_fingers_same_time(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void flexion_stretch_all_fingers_same_time(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void flexion_stretch_all_fingers(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void stretch_flexion_all_fingers(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);

//Left and Right movement of Fingers
void right_left_thumb(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void left_right_thumb(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void left_right_middlefinger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void right_left_middlefinger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void right_left_ring_little_finger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void left_right_ring_little_finger(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void left_right_all_fingers(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void right_left_all_fingers(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);

//wrist control
void neutral_position_wrist(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void extension_flexion_wrist(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void flexion_extension_wrist(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void radial_ulnar_wrist(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
void ulnar_radial_wrist(Adafruit_PWMServoDriver &pwm1, Adafruit_PWMServoDriver &pwm2);
